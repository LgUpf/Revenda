  ...
  <div class="card">
    ...
    <div class="card-body">
      ...
      <div class="form-group">
        {!! Form::label('nome', 'Nome do Comprador:') !!}
...
@section('js')
	<script>
		$(document).ready(function(){
			...
			x++;
			var newField = '<div><div style="width:94%; float:left" id="carro">{!! Form::select("carros[]",
                    \App\Models\Modelo::orderBy("descricao")->pluck("descricao","id")->toArray(),
                    null, ["class"=>"form-control", "required", "placeholder"=>"Selecione um Carro"]) !!}</div><button type="button" class="remove_field btn btn-danger btn-circle"><i class="fa fa-times"></button></div>';
